...
<div class="main_box">
	...
	<div class="left_side_box">
		<br><br><br>
		<img src="${ pageContext.request.contextPath }/resources/images/grade_gold.JPG" width="70px" height="70px">&nbsp;&nbsp;<br>
		<span>등급&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
	</div>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<img src="${ pageContext.request.contextPath }/resources/images/member_profile.png" width="120px" height="120px"><br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="">개인정보수정</a>
