...
<script type="text/javascript">
	...
	function reply_form(){
		...
		location.href="reply_form.do?carpool_idx=${ vo.carpool_idx }&page=${param.page}";
	}
	...
	function del(){
		...
		//확인 누르면 삭제하러 가기
		location.href="delete.do?carpool_idx=${ vo.carpool_idx }&page=${ param.page }";
	...
	function modify_form(){
		...
		//수정폼 띄우기
		location.href="modify_form.do?carpool_idx=${ vo.carpool_idx }&page=${ param.page }";
