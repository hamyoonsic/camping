...
public class ReviewController {
	...
	/*
	 * @RequestMapping(value="/review/list.do") public String
	 ...
	 * 
	 * if (search.equals("review_title_review_content_mem_nickname")) {
	 * //제목+내용+작성자닉네임
	 * 
	 * map.put("review_title", search_text); map.put("review_content", search_text);
