...
public class Paging {
	...
	public static String getCategoryPaging(int nowPage, int rowTotal,
		...
		//-----그룹페이지처리 이전 --------------------------------------------------------------------------------------------		
		if (isPrevPage) {
			/* <a href='#comment_page' onclick='comment_list(1);'> */
			sb.append(String.format("<a href='#comment_page' onclick='category_list(%d);'>◀</a>",
					                                                       startPage-1));
		} else
			sb.append("◀");
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (i == nowPage) { // 현재 있는 페이지
				 ...
				 * sb.append("<span class='num_box'>"); sb.append(i); sb.append("</span>");
				 */
				/* sb.append("</font></b>"); */
				sb.append("<span class='num_box'>");
				sb.append(String.format("<a href='#comment_page'><font color='red'>%d</font></a>",nowPage));
				sb.append("</span>");
				
			} else {// 현재 페이지가 아니면
				sb.append("<span class='num_box'>");
				sb.append(String.format("<a href='#comment_page' onclick='category_list(%d);'>%d</a>",i,i));
				sb.append("</span>");
			}
		} // end for
	...
	public static String getPaging(String pageURL,
			                        ...
			                        int nowPage, int rowTotal,int blockList, int blockPage){
